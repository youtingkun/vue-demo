<template>
	<canvas id="container" width="512" height="512" style="width: 512px; height: 512px"></canvas>
</template>

<script>
import * as spritejs from 'spritejs';
import { Cube, shaders, createGlobe, config } from 'sprite-extend-3d';
...
export default {
	...
	mounted() {
		...
		const globe = createGlobe(layer, {
			...
			// data: config.topojsonData, // 数据源，默认是测试数据源，可以传任何topojson格式的世界地理数据覆盖它
