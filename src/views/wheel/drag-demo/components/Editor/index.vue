...
export default {
	...
	// computed: mapState(['componentData', 'curComponent', 'canvasStyleData']),
	computed: {
		componentData: {
			get() {
	...
	methods: {
		handleContextMenu(e) {
			...
			this.$store.commit('dragDemo/showContexeMenu', { top, left });
		},
		...
		handleInput(element, value) {
			...
			// 根据文本组件高度调整 shape 高度
			this.$store.commit('dragDemo/setShapeStyle', { height: this.getTextareaHeight(element, value) });
		},
